...
def get_args(**kwargs):
    ...
    parser.add_argument('-b', '--batch-size', metavar='BS', type=int, default=64,
                        help='Batch size', dest='batch')
    parser.add_argument('-e', '--train-epochs', type=int, default=300,
                        help='Train epochs', dest='TRAIN_EPOCHS')
